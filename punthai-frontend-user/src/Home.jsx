...
return (
    <>
      ...
      {user && projects.length > 0 ? (
        ...
        /* --- Hero Section (แสดงเมื่อยังไม่ล็อกอิน หรือ ล็อกอินแล้วแต่ยังไม่มีโปรเจกต์) --- */
      ...
      {/* 👇 ส่วนด้านล่างนี้ (Features, About, Steps, Gallery, Footer, Popup) เอาไว้คงเดิมทั้งหมดเลยครับ 👇 */}
